...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{route('miner.crear')}}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('post')

            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Agregar Mineral') }}</h4>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                   ...
                   <div class="form-group{{ $errors->has('nombreMineral') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('nombreMineral') ? ' is-invalid' : '' }}" name="nombreMineral" id="nombreMineral" type="text" placeholder="{{ __('Mineral') }}" value="{{ old('nombreMineral') }}" required="true" aria-required="true"/>

...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{route('tipoEvento.crear')}}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('post')

            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Agregar Evento') }}</h4>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                   ...
                   <div class="form-group{{ $errors->has('nombretipoEvento') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('nombretipoEvento') ? ' is-invalid' : '' }}" name="nombretipoEvento" id="nombretipoEvento" type="text" placeholder="{{ __('Nombre Evento') }}" value="{{ old('nombretipoEvento') }}" required="true" aria-required="true"/>

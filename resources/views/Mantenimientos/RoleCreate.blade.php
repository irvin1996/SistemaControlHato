...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{route('roles.crear')}}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('post')

            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Agregar Rol') }}</h4>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                   ...
                   <div class="form-group{{ $errors->has('nombreRole') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('nombreRole') ? ' is-invalid' : '' }}" name="nombreRole" id="nombreRole" type="text" placeholder="{{ __('Rol') }}" value="{{ old('nombreRole') }}" required="true" aria-required="true"/>
